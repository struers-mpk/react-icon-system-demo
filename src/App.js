      ...
      <main className="ph3 ph5-l pt4 pb5 dark-gray">
        <div className="mv5">
          ...
          <p className="gray measure-wide lh-copy">
            Each icon has been built on a square canvas which results in a
            square <code className="bg-near-white f5 pa1">viewBox</code> for
            example:{" "}
            <code className="bg-near-white f5 pa1">viewBox="0 0 20 20"</code>.
            The width and height attributes are set to{" "}
            <code className="bg-near-white f5 pa1">1em</code>. The fill colour
            is set to <code className="bg-near-white f5 pa1">
              currentColor
            </code>. Therefore, we can easily size and style the icons using
            font/dimension and colour CSS classes.
          </p>

          <p className="gray measure-wide lh-copy">
            usage:{" "}
            <code className="bg-near-white f5 pa1">
        ...
        <p>
          ...
          eiusmod tempor incididunt ut <Icon type="moon-with-craters" /> labore
          et dolore magna aliqua. Ut enim <Icon type="thermometer" /> ad minim
          veniam, <Icon type="wind" /> quis nostrud exercitation ullamco laboris
          nisi ut aliquip ex ea commodo consequat. <Icon type="orbit" />
        </p>

        <p>
          <a
            className="f6 link dim br2 ph3 pv2 mb2 mr2 dib white bg-dark-gray"
            href="#0"
          >
        ...
        <div className="flex justify-between mv4">
          <Icon
            type="method-lubricant"
            className="db w200 h200 red"
            width="200px"
            height="200px"
          />
          <Icon
            type="method-suspension"
            className="db w200 h200 green"
            width="200px"
            height="200px"
          />
